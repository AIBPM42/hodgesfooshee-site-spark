        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/" className="text-white/80 hover:text-brand-200 transition-smooth">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/listings" className="text-white/80 hover:text-brand-200 transition-smooth">
                  Properties
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-white/80 hover:text-brand-200 transition-smooth">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-white/80 hover:text-brand-200 transition-smooth">
                  Contact
                </Link>
              </li>
            </ul>
